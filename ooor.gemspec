Gem::Specification.new do |s|
  ...
  s.files = [ "README.md", "MIT-LICENSE", "lib/ooor.rb", "lib/app/models/open_object_resource.rb", "lib/app/models/open_object_ui.rb", "lib/app/controllers/open_objects_controller.rb", "ooor.yml"]
